...
<head>
    ...
    <![endif]-->
    <title>PMC Equipment Management System | Admin Dashboard</title>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-info back-widget-set text-center">
                        ...
                        <?php
                        $sql1 = "SELECT issueID from issues ";
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-warning back-widget-set text-center">
                        ...
                        <?php
                        $status = 0;
                        $sql2 = "SELECT * from request where status=:status";
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-danger back-widget-set text-center">
                        ...
                        <?php
                        $status=0;
                        $sql3 = "SELECT * from issues where returnstatus=:status";
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-3 col-xs-6">
                    <div class="alert alert-success back-widget-set text-center">
                        ...
                        <?php
                        $status=1;
                        $sql4 = "SELECT id from user where corestatus=:status ";
                        $query4 = $db->prepare($sql4);
                        $query4->bindParam(':status', $status, PDO::PARAM_STR);
                        $query4->execute();
                        $results4 = $query4->fetchAll(PDO::FETCH_OBJ);
                        $core = $query4->rowCount();
                        ?>
                        <h3><?php echo htmlentities($core); ?></h3>
                        Core Member(s)
                    </div>
                </div>
